...
This is the coding AI tool available I have available at work. You can do many things with Kiro cli, executing prompts for troubleshooting, understanding the code, create test and new code, create agents for structured procedures...
...
Then I started again providing the requirements one by one. I let Kiro decide about the design and coding. Most probably my prompts where not the best ones neither. After some time I had a better program but with really tangled code.
...
The first thing here was that I did not know about Kiro features, such that you can save prompts that are added to the context, and you do not need to repeat all the time sentences like "act as an experienced software engineer" at the beginning. Second, 
once I turned off the computer and started again the following day, the context was missed, although I explained again the requirements and so on, it was not the same.
In addition, what I did, from time to time, was to ask Kiro to review the code and perform improvements. First time I did that, the tests failed. Then I asked better to provide a list of improvements, numbered, and start by improvement number 1, while 
...
This time, I guided kiro in the design of the program. I thought about the design in advanced, therefore I provided more concise prompts guiding step by step Kiro. 
